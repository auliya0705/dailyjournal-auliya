            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-5" id="staticBackdropLabel">Tambah Gambar</h5>
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="judul" placeholder="Tuliskan Judul Foto"
                                    required>
                            </div>
                            <div class="mb-3">
...
if (isset($_POST['simpan'])) {
    ...
    if (isset($_POST['id'])) {
        ...
        $stmt->bind_param("ssssi", $judul, $foto, $tanggal, $username, $id);
        $simpan = $stmt->execute();
    } else {
		    //jika tidak ada id, lakukan insert data baru
        $stmt = $conn->prepare("INSERT INTO gallery (judul,foto,tanggal,username)
                                VALUES (?,?,?,?)");

        $stmt->bind_param("ssss", $judul, $foto, $tanggal, $username);
        $simpan = $stmt->execute();
    }
