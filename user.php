            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fs-5" id="staticBackdropLabel">Tambah User</h5>
...
if (isset($_POST['simpan'])) {
    ...
    if (isset($_POST['id'])) {
        ...
        $stmt->bind_param("sssi", $username, $epassword, $foto, $id);
        $simpan = $stmt->execute();
    } else {
        ...
        $stmt->bind_param("sss", $username, $epassword, $foto);
        $simpan = $stmt->execute();
    }
