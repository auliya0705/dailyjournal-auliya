...
<body>
    ...
    <nav class="navbar navbar-expand-sm text-center bg-dark p-2 sticky-top">
        <div class="container">
            <a class="navbar-brand text-white" href="home.php">My Daily Journal</a>
    ...
    <footer class="container-fluid text-center text-white bg-dark p-2 justify-content-center fixed-bottom">
        ...
        ><i class="bi bi-twitter h2 p-2k"></i
        ></a> -->
            <a href="https://wa.me/+6285326760482" target="_blank"><i class="bi bi-whatsapp h2 p-2 text-white"></i></a>
        </div>
        <div>Auliya Shadrina Nabilah &copy; 2024</div>
    </footer>
    <!-- footer end -->
